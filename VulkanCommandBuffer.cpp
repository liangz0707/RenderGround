...
void VulkanCommandBuffer::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
	...
	// ���������ԭʼ���ݿ���ʹ��VK_IMAGE_LAYOUT_UNDEFINED 
	...
	if (oldLayout == VK_IMAGE_LAYOUT_UNDEFINED && newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
		barrier.srcAccessMask = 0; //���ɷ���
		barrier.dstAccessMask = VK_ACCESS_TRANSFER_WRITE_BIT;

		sourceStage = VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT; // ����֮��ʼ
		destinationStage = VK_PIPELINE_STAGE_TRANSFER_BIT; // ����֮ǰ������ָ��������Ҫ�ȴ�
	}
	...
	vkCmdPipelineBarrier(
		commandBuffer,
		sourceStage /* �ĸ��ܵ��׶εĲ���Ӧ�÷�������֮ǰ */,
		destinationStage /* �ĸ��׶�Ӧ�õȴ����Ϸ���֮�� */,
		0,
		0, nullptr,
		0, nullptr,
		1, &barrier
